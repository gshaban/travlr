...
The submitted project includes the dependencies needed for the developer to run the backend with `npm start`. The backend runs at:
...
I used ChatGPT to help review the assignment rubric, organize my reflection, revise the README and help me write this portfolio. I reviewed and edited the final content before submission.
